...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference('Vendor.count') do
      post vendors_url, params: { vendor: { code: @vendor.code, name: @vendor.name, org_unit: @vendor.org_unit, status: @vendor.status } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { code: @vendor.code, name: @vendor.name, org_unit: @vendor.org_unit, status: @vendor.status } }
